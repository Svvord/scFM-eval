...
def process_raw_anndata(row, h5_folder_path, npz_folder_path, scp, skip,
                        additional_filter, root, EMBEDDING_DIR=None):
        path = row.path
        ...
        dataset, adata = anndata_to_sc_dataset(ad, species=species, labels=labels, covar_col=covar_col, hv_genes=None, EMBEDDING_DIR=EMBEDDING_DIR)
        adata = adata.copy()
